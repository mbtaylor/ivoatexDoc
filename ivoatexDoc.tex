...
\item Recommend that \verb|<original-repo>| be preserved for awhile but the owner 
should create a new fork (ref to Contributing section above) of the ivoa-std 
repository for future work
\end{enumerate}

Branch protection rules are setup in the ``Settings'' tab of the repository (top right). 
...
\todo{Pat will remove the tcg-members team so that the child wg admin teams are directly visible}
